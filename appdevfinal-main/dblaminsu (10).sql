...
--
-- Host: localhost:3306
-- Generation Time: Jan 30, 2024 at 11:39 AM
...
(99, 9, 7768, 7767, 'sold', '2023-12-20 14:15:35', '2023-12-20 06:15:35'),
(100, 45, 67, 72, 'inbound', '2023-12-21 05:53:42', '2023-12-20 21:53:42'),
(101, 45, 72, 77, 'inbound', '2023-12-21 05:54:20', '2023-12-20 21:54:20'),
(102, 45, 77, 82, 'inbound', '2023-12-21 05:55:04', '2023-12-20 21:55:04'),
(103, 45, 82, 84, 'inbound', '2023-12-21 05:55:53', '2023-12-20 21:55:53'),
(104, 45, 84, 86, 'inbound', '2023-12-21 05:57:01', '2023-12-20 21:57:01'),
(105, 45, 86, 87, 'inbound', '2023-12-21 05:57:51', '2023-12-20 21:57:51');
...
(86, 75, 9, 1, '2023-12-20 06:15:05', '2023-12-20 06:15:05');
...
(106, 75, '2023-12-20 06:15:14', 144, 'LMCC90911703052914');
...
(9, '4asdfghjkl', 'Wide selection of craft beers', 1111.00, 5, 'receipt (10).png', '2023-12-02 19:07:00', 7767),
...
(45, 'Margarita', 'Refreshing and delicious cocktails', 55.00, 4, 'android-chrome-maskable-512x51', '2023-12-13 23:01:18', 87),
...
INSERT INTO `notifications` (`id`, `user_id`, `message`, `link`, `timestamp`) VALUES
(3, 92, 'Your reservation has been confirmed.', '', '2023-12-21 05:22:42');
...
(144, 75, 'takeout', NULL, '', '2023-12-20 06:15:14', 'pending', 1111.00, NULL);
...
(29, 75, '19:12:00', '2023-12-27', 'xcvbnm,', '2023-12-08 11:08:35', '2023-12-20 23:26:33', 2, 'booked'),
(30, 78, '19:51:00', '2023-12-26', 'lkjhgfdszxcvbn', '2023-12-08 11:47:50', '2023-12-20 23:26:43', 4, 'booked'),
(31, 92, '09:23:00', '2023-12-27', 'sdfghjkl', '2023-12-20 23:23:58', '2023-12-20 23:24:27', 4, 'booked'),
(32, 92, '07:34:00', '2023-12-27', 'sdfghjkl', '2023-12-20 23:30:03', '2023-12-20 23:30:18', 2, 'booked'),
(33, 92, '07:39:00', '2023-12-27', 'sdfghjkl', '2023-12-20 23:35:46', '2023-12-20 23:35:57', 4, 'booked'),
(34, 92, '13:25:00', '2023-12-29', 'asdfghjkl;\'', '2023-12-21 05:22:12', '2023-12-21 05:22:42', 2, 'booked'),
(35, 75, '13:43:00', '2023-12-21', 'asdfg', '2023-12-21 05:44:03', '2023-12-21 05:44:03', 1, 'pending');
...
--
ALTER TABLE `audit`
  MODIFY `audit_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;
...
--
ALTER TABLE `invoices`
  MODIFY `invoice_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
...
--
ALTER TABLE `orders`
  MODIFY `order_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=145;

--
-- AUTO_INCREMENT for table `order_items`
--
ALTER TABLE `order_items`
  MODIFY `orders_item_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=192;
